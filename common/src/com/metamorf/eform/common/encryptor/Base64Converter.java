...
public class Base64Converter {
	private static final Logger LOGGER = LoggerFactory.getLogger(Base64Converter.class);

   /** Field BASE64DEFAULTLENGTH */
   public static final int BASE64DEFAULTLENGTH = 76;

   /** Field _base64length */
   static int _base64length = Base64Converter.BASE64DEFAULTLENGTH;
    ...
    *
    */
   public static byte[] decode(byte[] base64) throws RuntimeException  {
    ...
    * @throws RuntimeException
    */
   public final static byte[] decode(String encoded) throws RuntimeException {
   ...
   protected final static byte[] decodeInternal(byte[] base64Data) throws RuntimeException {
       // remove white spaces
       ...
       if ((b1==-1) || (b2==-1)) {
                throw new RuntimeException("decoding.general");//if found "no data" just return null
        }
        ...
        if ((b3==-1 ) || (b4==-1) ) {
            ...
            if (isPad( d3 ) && isPad( d4)) {               //Two PAD e.g. 3c[Pad][Pad]
                ...
                throw new RuntimeException("decoding.general");//an error  like "3c[Pad]r", "3cdX", "3cXd", "3cXX" where X is non data
            }
        } else {
            //No PAD e.g 3cQl
   ...
   public final static void decode(byte[] base64Data,
        OutputStream os) throws RuntimeException, IOException {
    // remove white spaces
    int len = removeWhiteSpace(base64Data);
