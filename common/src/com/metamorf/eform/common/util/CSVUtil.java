...
public class CSVUtil {
	 ...
	 * @since ostermillerutils 1.00.00
	 */
	public CSVUtil (OutputStream out, char commentStart){
		this(out);
	 ...
	 * @since ostermillerutils 1.00.00
	 */
	public CSVUtil (Writer out, char commentStart){
		this(out);
		this.commentStart = commentStart;
	}
	 ...
	 * @since ostermillerutils 1.00.00
	 */
	public void printlnComment(String comment){ // NOPMD by AGE-SYSTEM on 9/30/13 10:17 AM, this is util from 3rd party, not going to fix for now
	 ...
	 * @since ostermillerutils 1.00.00
	 */
	public void print(String value){ // NOPMD by AGE-SYSTEM on 9/30/13 10:17 AM, this is util from 3rd party, not going to fix for now
		if (value == null) value = "";
		boolean quote = false;
		if (value.length() > 0){
