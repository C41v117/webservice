...
//	    return result;
	 ...
	 * @throws Exception
	 */
	public static Field findField(Class<?> clazz, String name, Class<?> type) throws Exception{
...
//		return null;
		throw new Exception("cannot find field :"+name+" from class :"+clazz.getCanonicalName());
	}
	 ...
	 * @return the Method object, or <code>null</code> if none found
	 */
	public static Method findMethod(Class<?> clazz, String name, Class<?>[] paramTypes) throws Exception {
//		Assert.notNull(clazz, "Class must not be null");
//		Assert.notNull(name, "Method name must not be null");
		...
		throw new Exception("cannot find method :"+name+" from class :"+clazz.getCanonicalName());
	}
